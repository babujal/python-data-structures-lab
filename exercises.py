...
def manage_students():
    # your code here
    students_list = ['Zandra', 'Santiago', 'Pilar']
    first_student = students_list[1]
    last_student = students_list[2]
    print(f'First student was: {first_student} and last student is: {last_student}')
...
def hometown_info():
    # your code here
    home_town = {'city': 'Lakeland', 'state': 'Florida', 'population': 122.264}
